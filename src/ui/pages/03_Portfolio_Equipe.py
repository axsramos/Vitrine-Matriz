...
if not equipe:
    ...
    # --- CENTRALIZAÇÃO EM COLUNA ÚNICA ---
    # Criamos 3 colunas: [Margem, Conteúdo, Margem]
    # O conteúdo central ocupa 6 partes de 12 (50% da largura da tela)
    _, col_central, _ = st.columns([3, 6, 3])
